...
class RegisterActivity : AppCompatActivity() {
    ...
    private var imgPwdBadge: ImageView? = null   // nếu có badge trong XML thì findViewById, còn không để null cũng không sao
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        edtPassword = findViewById(R.id.edtPassword)
        edtConfirmPassword = findViewById(R.id.edtConfirmPassword)
        // imgPwdBadge = findViewById(R.id.imgPwdBadge) // nếu trong layout có ImageView badge thì mở dòng này
